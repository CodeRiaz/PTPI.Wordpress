<section class="conferences-wrapper">
    <?php am_the_field( 'conf_heading', '<div class="heading"><h4 class="title">', '</h3></div>', false, true ); ?>
    ...
    <?php $heading_previous = get_field( 'conf_heading_previous', 'option' ); ?>
    <?php if ( have_rows( 'conf_previous_conferences', 'option' ) ) : ?>
    <div class="conferences-detail layout-<?php the_field( 'conf_layout', 'option' ); ?>">
        <div class="left-col">
            <div class="previous-conference">
                ...
                <ul>
                    <?php while ( have_rows( 'conf_previous_conferences', 'option' ) ) : the_row(); ?>
                    <li>
        ...
        <div class="right-col">
            <div class="slider__wrapper">
                <div class="slider conference-slider">
                    <?php
                        while ( have_rows( 'conf_previous_conferences', 'option' ) ) : the_row();
